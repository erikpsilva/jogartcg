<header class="header">
    <div class="header__logo">
        ...
        <a href="<?= adminUrl('inicio') ?>"><img src="<?= BASE_URL ?>/client/brand/logo-jogar-tcg.png" alt="Jogar TCG" /></a>
    ...
    <div class="header__user">
        ...
        <a href="<?= adminUrl('logout') ?>" class="btn btn--gray header__user__logout">Sair</a>
    </div>
</header>
