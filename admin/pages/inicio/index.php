    ...
    <main class="adminLayout__content">
        ...
        <section class="adminInicio">
            ...
            <div class="adminCards">
                ...
                <article class="adminCard"><span class="adminIcon" aria-hidden="true"><i class="fa-solid fa-users"></i></span><h2>Usuários do site</h2><p>Consulte os jogadores, edite seus perfis e libere o acesso aos beta testers.</p><a class="btn btn--primary" href="<?= adminUrl('usuarios-site') ?>">Gerenciar usuários</a></article>
                <article class="adminCard"><span class="adminIcon" aria-hidden="true">◇</span><h2>Configurações</h2><p>Ative ou desative o menu Jogar e controle a disponibilidade da arena.</p><a class="btn btn--primary" href="<?= adminUrl('configuracoes') ?>">Gerenciar configurações</a></article>
                <?php endif; ?>
