...
<div class="adminLayout">
    ...
    <main class="adminLayout__content">
        ...
        <form class="settingsPanel" method="post" action="<?= adminUrl('configuracoes') ?>">
            ...
            <div class="settingsNotice"><span aria-hidden="true">↳</span><p>Ao desativar, os links para jogar são ocultados e o acesso direto à arena fica indisponível para o público. <strong>Beta testers ativos e logados continuam com acesso.</strong> Gerencie essa permissão em <a href="<?= adminUrl('usuarios-site') ?>">Usuários do site</a>. O catálogo e os decks continuam funcionando normalmente.</p></div>
