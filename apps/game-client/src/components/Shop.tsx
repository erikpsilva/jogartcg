...
type Item = { active?: boolean; description?: string; id: string; name: string; type: 'playmat' | 'sleeve'; image: string; gold: number | null; reais: number | null };
